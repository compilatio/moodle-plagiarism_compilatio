...
$string['always_enabled'] = "Always enabled";
...
$string['configurable_detections_options'] = 'Configurable detections options :';
...
$string['detection_ai_detection_activated'] = 'Ai detection is configurable.';
$string['detection_ai_detection_activated_unchanged'] = 'Ai detection is activated <br><strong>(Can\'t be changed)</strong>';
$string['detection_ai_detection_configurable'] = 'Ai detection is activated.';
$string['detection_ai_detection_desactivated'] = 'Ai detection is desactivated by administrator.';
$string['detection_rewording_activated'] = 'Rewording detection is configurable.';
$string['detection_rewording_activated_unchanged'] = 'Rewording detection is activated <br><strong>(Can\'t be changed)</strong>';
$string['detection_rewording_configurable'] = 'Rewording detection is activated.';
$string['detection_rewording_desactivated'] = 'Rewording detection is desactivated by administrator.';
$string['detection_similarity_activated'] = 'Similarity detection is activated.';
$string['detection_similarity_configurable'] = 'Similarity detection is configurable.';
$string['detection_similarity_desactivated'] = 'Similarity detection is desactivated by administrator.';
$string['detection_unrecognized_text_language_activated'] = 'Unrecognized text language detection is enabled.';
$string['detection_unrecognized_text_language_activated_unchanged'] = 'Unrecognized text language detection is activated <br><strong>(Can\'t be changed)</strong>';
$string['detection_unrecognized_text_language_configurable'] = 'Unrecognized text language detection is configurable.';
$string['detection_unrecognized_text_language_desactivated'] = 'Unrecognized text language detection is desactivated by administrator.';
