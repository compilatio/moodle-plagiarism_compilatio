...
$string['word_limits'] = 'To be able to be analyzed, a text must have between {$a->min} and {$a->max} word';
...
$string['analyzed_docs'] = '{$a} analyzed document(s)';
$string['analyzing_docs'] = '{$a} document(s) being analyzed';
