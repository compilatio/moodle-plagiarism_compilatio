...
$string['migration_failed_doc'] = "document n'ont pas pu être mis à jour, vous pouvez réessayer de mettre à jour ces documents à la fin de la mise à jour.";
...
$string['privacy:metadata:plagiarism_compilatio_files:userid'] = "L'identifiant Moodle de l'utilisateur qui a fait la soumission";
$string['privacy:metadata:plagiarism_compilatio_files:filename'] = 'Nom du fichier soumis ou nom généré pour les contenus texte';
