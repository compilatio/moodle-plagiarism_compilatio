...
$string['help_compilatio_thresholds_title'] = 'Wie kann man die Farbe des Resultats der Dokumentenanalyse ändern?';
$string['help_compilatio_thresholds_content'] = 'Die Farben der Resultate können in der Konfiguration jeder Aufgabe unter der Rubrik „Compilatio Plugin zur Plagiatserkennung“ definiert werden.<br/>
 Es besteht die Möglichkeit Grenzwerte auszuwählen, welche die Farbe der Anzeige der Ähnlichkeitsquoten bestimmen.';

$string['help_compilatio_format_title'] = 'Welche Dokumentformate werden unterstützt?';
...
$string['help_compilatio_languages_title'] = 'Welche Sprachen werden unterstützt?';
$string['help_compilatio_languages_content'] = "Die Ähnlichkeitsanalysen können in über 40 Sprachen ausgeführt werden (alle romanischen Sprachen eingeschlossen). <br/>
Das chinesische, japanische, arabische und kyrillische Alphabet werden noch nicht unterstützt.";

$string['admin_help_compilatio_api_title'] = 'Wie erhält man einen API-Key?';
$string['admin_help_compilatio_api_content'] = "Damit dieses Plugin funktioniert, ist ein Abonnement für Compilatio.net Dienstleistungen erforderlich. <br/>
Kontaktieren Sie Ihren kaufmännischen Gesprächspartner oder fordern Sie auf der Adresse <a href='mailto:ent@compilatio.net'>ent@compilatio.net</a> einen API-Key an.";

$string['compilatio_faq'] = "<a target='_blank' href='https://www.compilatio.net/faq/'>Häufig gestellte Fragen - Compilatio.net</a>";
...
$string['indexed_document'] = "In der Referenzbibliothek enthaltenes Dokument";
$string['not_indexed_document'] = "Nicht in der Referenzbibliothek enthaltenes Dokument";
