...
class document_frame {
    ...
    public static function display_document_frame(
        ...
        $output = $info . '
            <div class="cmp-area cmp-border-' . $bgcolor . '" data-documentid="' . $documentid . '">
                <img
                    class="cmp-small-logo"
                    data-testid="compilatio-logo"
                    src="' . new moodle_url("/plagiarism/compilatio/pix/c.svg") . '"
                >
    ...
    public static function get_score($cmpfile, $config, $isteacher, $nowrap = false): string {
        ...
        $html = "
            <span
                title='{$title}'
                data-testid='compilatio-score-label'
                class='cmp-similarity cmp-color-{$color} d-flex align-items-center justify-content-center'
            >
     ...
     */
    private static function format_string(
        string $stringid,
        string $component = 'plagiarism_compilatio',
        ?string $a = null
    ): string {
