...
class CompilatioIcons {
    ...
    public static function ellipsis() {
        return "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 512' height='1.25em'>
                <path fill='#6D6D6D' d='M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z'></path>
            </svg>";
    }

    public static function arrowLeft() {
        return "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' height='1em' class='mr-2'>
                <path fill='#6D6D6D' d='M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z'></path>
            </svg>";
    }

    public static function statisticsPerStudent() {
        return "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 512' height='1em'>
                <path fill='#6D6D6D' d='M160 64c0-35.3 28.7-64 64-64H576c35.3 0 64 28.7 64 64V352c0 35.3-28.7 64-64 64H336.8c-11.8-25.5-29.9-47.5-52.4-64H384V320c0-17.7 14.3-32 32-32h64c17.7 0 32 14.3 32 32v32h64V64L224 64v49.1C205.2 102.2 183.3 96 160 96V64zm0 64a96 96 0 1 1 0 192 96 96 0 1 1 0-192zM133.3 352h53.3C260.3 352 320 411.7 320 485.3c0 14.7-11.9 26.7-26.7 26.7H26.7C11.9 512 0 500.1 0 485.3C0 411.7 59.7 352 133.3 352z'></path>
            </svg>";
    }
