...
class CompilatioDocumentFrame {
    ...
    public static function display_document_frame(
        ...
        if ($status == 'scored') {
            ...
            $report = '';
            if ($canviewreport) {
                $documentFrame = "<a href='" . $CFG->httpswwwroot . "/plagiarism/compilatio/redirect_report.php?docid=" . $cmpfile->externalid . "&cmid=" . $cmpfile->cm . "' target='_blank' class='cmp-btn cmp-btn-doc cmp-btn-primary cursor-pointer'>
            ...
            // TODO delete OR
            if (($config->analysistype ?? null) == 'planned' || $cmpfile->externalid == "5864ce5ed66fc938e0e60ed36c73e70a8bb200f9") {
                $documentFrame = "<div title='" . get_string('title_planned', "plagiarism_compilatio", userdate($config->analysistime)) . "' class='cmp-btn-secondary'>
                ...
                $documentFrame = "<div title='" . get_string('title_sent', "plagiarism_compilatio") . "' class='cmp-btn cmp-btn-doc cmp-btn-primary cursor-pointer'>
            ...
            $documentFrame = "<div title='" . get_string('title_' . $status, "plagiarism_compilatio") . "' class='cmp-btn-secondary'>
            ...
            $documentFrame = "<div title='" . get_string("title_" . $status, "plagiarism_compilatio", $value ?? null) . "' class='cmp-btn-error'>
                    <i class='cmp-mr-10 cmp-ml-5 fa fa-exclamation-triangle'></i>" . get_string('btn_' . $status, "plagiarism_compilatio") . 
                "</div>";
            $bgcolor = 'error';
            ...
            $documentFrame = "<a href='" . $url . "' target='_self' title='" . get_string('title_unsent', "plagiarism_compilatio") . "' class='cmp-btn cmp-btn-doc cmp-btn-primary cursor-pointer'>
                    <i class='cmp-icon-lg cmp-mr-10 fa fa-play-circle'></i>"
