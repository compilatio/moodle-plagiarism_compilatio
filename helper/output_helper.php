...
class output_helper
{
    ...
    public static function get_logo() {
        ...
        return '<img title="Compilatio" id="compilatio-logo" src="' .
            $OUTPUT->pix_url('compilatio-logo-' . $language, 'plagiarism_compilatio') .'">';
    }
        ...
        if ($indexingstate === true) {
            $html .= '
                <div
                    class="library-in"
                    style="
                        background-image: url(\'' . new moodle_url("/plagiarism/compilatio/pix/library-in.png") . '\');
            ...
            $html .= '
                <div
                    class="library-out"
                    style="
                        background-image: url(\'' . new moodle_url("/plagiarism/compilatio/pix/library-out.png") . '\');
                        background-size: cover;"
    ...
    public static function get_plagiarism_area($span = "",
        ...
        $html .= '<div class="compilatio-area">';
    ...
    public static function get_image_similarity($score,
        ...
        $image = $OUTPUT->pix_url($color, 'plagiarism_compilatio');
